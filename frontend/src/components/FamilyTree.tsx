...
// Make sure you have FamilyTree loaded globally, e.g. via <script src="https://balkan.app/js/familytree.js"></script>
// OR import it if you’re bundling locally: import FamilyTree from "@balkan/familytree";

export const RoyalFamilyTree: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const chart = new FamilyTree(treeRef.current, {
    ...
    chart.load([
      ...
      { id: 5, mid: 2, fid: 1, name: "Princess Margaret", img: "https://cdn.balkan.app/shared/f6.png", gender: "female" },
      ...
      { id: 12, fid: 6, mid: 7, pids: [14], name: "Prince William", title: "Duke of Cambridge", img: "https://cdn.balkan.app/shared/f14.png", gender: "male" },
      ...
      { id: 17, fid: 12, mid: 14, name: "Princess Charlotte", img: "https://cdn.balkan.app/shared/f18.png", gender: "female" },
